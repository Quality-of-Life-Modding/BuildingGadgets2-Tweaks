package com.cookta2012.buildinggadgets2tweaks;
...
public class Helper {
	 ...
	 public static boolean mayExchange(ServerLevel level, Player player, BlockPos pos) { //don't work due to no place
		 return canBreak(level, player, pos) && mayPlace(level, player, pos);
	 }
	 
	 public static boolean mayPlace(ServerLevel level, Player player, @NotNull BlockPos pos) {  //don't do shit
	 ...
	 public static boolean canBreak(Level level, Player player, BlockPos pos) { //correct ish does not take op into account
